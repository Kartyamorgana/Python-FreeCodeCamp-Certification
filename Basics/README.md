## Daftar Isi
1. [Apa Itu Python dan Penggunaan Umumnya di Industri?](#apa-itu-python-dan-penggunaan-umumnya-di-industri)
2. [Cara Mendeklarasikan Variabel dan Konvensi Penamaan](#cara-mendeklarasikan-variabel-dan-konvensi-penamaan)
3. [Bagaimana Fungsi `print()` Bekerja](#bagaimana-fungsi-print-bekerja)
4. [Tipe Data Umum di Python](#tipe-data-umum-di-python)
5. [Fungsi `type()` dan `isinstance()`](#fungsi-type-dan-isinstance)
6. [String dan Immutabilitas String](#string-dan-immutabilitas-string)
7. [Penggabungan String (*Concatenation*) dan Interpolasi String](#penggabungan-string-concatenation-dan-interpolasi-string)
8. [*String Slicing* (Mengiris String)](#string-slicing-mengiris-string)
9. [Metode-Metode String yang Umum](#metode-metode-string-yang-umum)
10. [Bekerja dengan Integer dan Floating Point Numbers](#bekerja-dengan-integer-dan-floating-point-numbers)
11. [*Augmented Assignments* (Penugasan Gabungan)](#augmented-assignments-penugasan-gabungan)
12. [Pernyataan Kondisional dan Operator Logika](#pernyataan-kondisional-dan-operator-logika)
13. [Nilai *Truthy* dan *Falsy*, Operator Boolean, dan *Short-Circuiting*](#nilai-truthy-dan-falsy-operator-boolean-dan-short-circuiting)
14. [Fungsi di Python](#fungsi-di-python)
15. [Scope (Ruang Lingkup) di Python – Aturan LEGB](#scope-ruang-lingkup-di-python--aturan-legb)
16. [Ringkasan Dasar-Dasar Python](#ringkasan-dasar-dasar-python)
