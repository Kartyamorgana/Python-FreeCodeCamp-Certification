...
- [## Apa Itu List dan Bagaimana Cara Kerjanya?](#apa-itu-list-dan-bagaimana-cara-kerjanya)
- [## Metode-Metode Umum pada List](#metode-metode-umum-pada-list)
- [## Apa Itu Tuple dan Bagaimana Cara Kerjanya?](#apa-itu-tuple-dan-bagaimana-cara-kerjanya)
- [## Metode-Metode Umum untuk Tuple](#metode-metode-umum-untuk-tuple)
  - [`count()`](#count)
  - [`index()`](#index)
  - [`sorted()`](#sorted)
- [## Bagaimana Cara Kerja Perulangan (Loop)?](#bagaimana-cara-kerja-perulangan-loop)
  - [`for` loop](#for-loop)
  - [`while` loop](#while-loop)
  - [`break` dan `continue`](#break-dan-continue)
  - [`else` pada loop](#else-pada-loop)
- [## Apa Itu Range dan Bagaimana Menggunakannya dalam Loop?](#apa-itu-range-dan-bagaimana-menggunakannya-dalam-loop)
- [## Fungsi `enumerate()` dan `zip()` serta Cara Kerjanya](#fungsi-enumerate-dan-zip-serta-cara-kerjanya)
  - [`enumerate()`](#enumerate)
  - [`zip()`](#zip)
- [## List Comprehension dan Fungsi-Fungsi Berguna untuk List](#list-comprehension-dan-fungsi-fungsi-berguna-untuk-list)
  - [`filter()`](#filter)
  - [`map()`](#map)
  - [`sum()`](#sum)
- [## Apa Itu Fungsi Lambda dan Bagaimana Cara Kerjanya?](#apa-itu-fungsi-lambda-dan-bagaimana-cara-kerjanya)
  - [Praktik Terbaik Lambda](#praktik-terbaik-lambda)
- [## Rangkuman: Perulangan dan Sequence](#rangkuman-perulangan-dan-sequence)
  - [Python Lists](#python-lists)
  - [Metode-Metode Umum pada List](#metode-metode-umum-pada-list-1)
  - [Tuples di Python](#tuples-di-python)
  - [Metode-Metode Umum untuk Tuple](#metode-metode-umum-untuk-tuple-1)
  - [Perulangan (Loops) di Python](#perulangan-loops-di-python)
  - [`range()`](#range)
  - [Fungsi `enumerate()` dan `zip()`](#fungsi-enumerate-dan-zip)
  - [List Comprehension](#list-comprehension-1)
  - [Fungsi-Fungsi Berguna untuk List (dan Iterable Umum)](#fungsi-fungsi-berguna-untuk-list-dan-iterable-umum)
